    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header">
              <div class="row">
              <form action="{{ route('admin.article.index') }}" method="post">
                <div class="col-md-3">
                    <div class="col-md-12 input-group input-group-sm ">
                        <select name="search_cid" class="form-control">
            ...
            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                      <a href="{{ route('admin.article.edit',[$article->id]) }}" class="btn btn-xs btn-info" >编辑</a>
                      <form method="post" action="{{ route('admin.article.destroy',[$article->id]) }}"  class="inline">
                          {{ csrf_field() }}
                          {{ method_field('DELETE') }}
                  ...
                  <div class="row">
                      <div class="col-sm-7">
                        <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
                            {{ $articles->appends(['search_cid' => $articles->cid,'search_title' => $articles->title])->links() }}
                        </div>
                      </div>
                  </div>
              </div>
