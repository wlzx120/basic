      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.article.create') }}">添加文章</a></li>
            <li><a href="{{ route('admin.article.index') }}">文章列表</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="javascript:void(0)"><i class="fa fa-link"></i> <span>栏目管理</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.column.create') }}">添加栏目</a></li>
            <li><a href="{{ route('admin.column.index') }}">栏目列表</a></li>
          </ul>
        </li>
